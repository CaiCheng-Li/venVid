...
$files = @('index.ts', 'patches.ts', 'attempt.ts', 'limits.ts', 'uploadAdapter.ts', 'CompressionModal.tsx', 'VideoTimeline.tsx', 'useCompressionJob.ts', 'compression.ts', 'styles.css', 'README.md', 'LICENSE', 'types.ts', 'native.ts', 'native')
