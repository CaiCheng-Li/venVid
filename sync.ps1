...
$files = @('index.ts', 'patches.ts', 'attempt.ts', 'limits.ts', 'uploadAdapter.ts', 'CompressionModal.tsx', 'compression.ts', 'proofVideo.ts', 'styles.css', 'README.md', 'PHASE-1.md', 'PHASE-2.md', 'LICENSE', 'types.ts', 'native.ts', 'native')
